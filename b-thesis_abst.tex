...
\begin{document}
    ...
    @@@ここ文法おかしいですし、「含む」もおかしいです@@@including reduced appetite and diminished taste perception.
    }
    ...
    \begin{figure}[h]
    \begin{center}
      \includegraphics[width=0.29\linewidth]{fig/negapozi_noodle.jpg}
    ...
    \begin{figure}[H]
     \begin{center}
      \includegraphics[width=0.75\linewidth]{fig/negapozisystem.png}
       \caption{Color inversion system @@@顔の素材は著作権的にOKですね？@@@}
        \label{fig:exp_system}
     \end{center}
    \end{figure}

    \section{実\hspace{2zw}験}
    被験者は20から26歳の男性10名とし、図2のようにMetaquest3@@@表記揺れ@@@を装着した状態で
