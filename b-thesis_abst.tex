...
\begin{document}
    ...
    \etitle{Verification of Appetite Suppression Effects Induced by Color Inversion Processing on Food@@@たぶんProcessing on Foodいらんかも@@@}{}
    ...
    We developed an application for Head-Mounted Displays @@@固有名詞じゃないのでキャピタライズしない@@@ that performs real-time negative-positive reversal of food appearance. 
    The experimental results confirmed @@@confirmは主語が人？suggestedのほうがいいかも@@@ that color-inverted food @@@foodはたぶん加算名詞なんじゃないかと（しらべといてください）@@@ elicited significant psychological reactions, 
    including reduced appetite and diminished taste perception.
    }
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=0.45\linewidth]{fig/negapozi_noodle.jpg}
    ...
    \section{提案手法}@@@手法とかいてしまうとそれが研究のすべての目的にみたいになってしまうので、ネガポジ反転システムの開発とか、そういうタイトルにしたほうがいいかも@@@
    ネガポジ反転処理を実現するため,@@@スペース抜け@@@VRヘッドマウントディスプレイである「Meta Quest 3」を用いた手法@@@手法には具体的な製品名を入れないこと。「開発」なら大丈夫@@@を提案する。
    ...
    被験者は20から26歳の男性10名とし、図2のようにMetaquest3を装着した状態で
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=0.5\linewidth]{fig/IMG_5322.jpg}
    \caption{The eating scene @@@Theはとりましょう（大げさなので）@@@}
    \label{fig:exp_human}
    \end{center}
    \end{figure}
    ...
    \begin{figure}[H]
    \begin{center}
    \includegraphics[width=0.5\linewidth]{fig/cupnoodle.jpg}
    \caption{Negative–positive inverted Noodle @@@スペースたりないのでminipage使って横並びに@@@ @@@タイトルでは何によってこうなるかを強調しましょう。Noodle observed through HMDとか？@@@}
    \label{fig:exp_Noodle}
    \end{center}
    \end{figure}

    実験結果を表1、表2@@@表1, 2@@@に示す。「見た目がおいしそうだった」という項目において, 通常時の平均値が5.3であったのに対し, ネガポジ視界時では1.7と大幅に低下した. 
...
\begin{table}[H]
  \centering
  \caption{Questionnaire results under normal visual conditions ($n=10$)@@@特に重要な数字を太字にするなど強弱を@@@}
  ...
  \resizebox{\columnwidth}{!}{
    \begin{tabular}{lcccc}
      ...
      Looked appetizing & 5.3 & 6.0 & 1.62 \\
      Perceived taste as usual & 6.2 & 7.0 & 1.25 \\
      Desire to continue eating & 6.2 & 7.0 & 1.17 \\
      Visual condition was uncomfortable & 3.3 & 3.0 & 1.95 \\
      Overall satisfaction & 5.7 & 6.5 & 1.68 \\
      \bottomrule
    \end{tabular}
  }
\end{table}
...
\begin{table}[H]
  ...
  \resizebox{\columnwidth}{!}{
    \begin{tabular}{lcccc}
      ...
      Looked appetizing & 1.7 & 1.0 & 1.19 \\
      Perceived taste as usual & 3.6 & 3.0 & 1.80 \\
      Desire to continue eating & 2.9 & 2.5 & 1.30 \\
      Visual condition was uncomfortable & 3.8 & 4.5 & 1.89 \\
      Overall satisfaction & 3.0 & 3.0 & 0.89 \\
      \bottomrule
    \end{tabular}
  }
\end{table}
