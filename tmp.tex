...
\begin{document}
    ...
    The experimental results suggested that color-inverted food @@@foodはたぶん加算名詞なんじゃないかと（しらべといてください）@@@ elicited significant psychological reactions, 
    ...
    ネガポジ反転処理を実現するため, VRヘッドマウントディスプレイである「Meta Quest 3」を用いた手法@@@手法には具体的な製品名を入れないこと．「開発」なら大丈夫@@@を提案する．
    ...
    \caption{Eating scene @@@Theはとりましょう（大げさなので）@@@}
    \label{fig:exp_human}
    \end{center}
    \end{figure}
